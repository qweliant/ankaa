...
config :ankaa, AnkaaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AnkaaWeb.ErrorHTML, json: AnkaaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ankaa.PubSub,
  live_view: [signing_salt: "SwZjzPUA"]
...
# config :ankaa, Ankaa.Mailer, adapter: Swoosh.Adapters.Local
