defmodule AnkaaWeb.StaticPageLive do
  ...
  def render(%{live_action: :privacy} = assigns) do
    ~H"""
      <div class="max-w-3xl mx-auto py-8">
        <%!-- This `raw/1` function renders the HTML exactly as-is,
            bypassing HEEX errors for <style> tags and { } brackets. --%>
  ...
  def render(%{live_action: :disclaimer} = assigns) do
    ...
    <div class="max-w-3xl mx-auto py-8 prose">
      <h1>Application Disclaimer</h1>
      <h2 class="text-red-600">For Informational & Pre-Alpha Use Only</h2>
      <p>
        <strong>
          SafeHemo is an experimental, pre-alpha application and is NOT a medical device.
        </strong>
      </p>
      <p>
      ...
      <p>
        It is NOT a life-saving device. In an emergency, **always call 911** or your
        ...
        <span style="color: rgb(127, 127, 127);">
            <span style="color: rgb(89, 89, 89); font-size: 15px;">
              <span data-custom-class="body_text">
                  ...
                  <bdt class="question noTranslate">Safehemo</bdt>
                  <bdt class="block-component"></bdt>
                  </bdt> (
                  <bdt class="block-component"></bdt>
